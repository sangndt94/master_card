...
loginAutoTestUserAndNavigate("MO/TO Acquirer", 1, "moto-acquirer/overview");

const navGroups = [
    {
        title: "Overview",
        path: "moto-acquirer/overview",
    ...
    },
    {
        ...
        path: "moto-acquirer/performance-drivers",
    ...
    },
    {
        ...
        path: "moto-acquirer/customer-insights",
