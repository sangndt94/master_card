...
loginAutoTestUserAndNavigate("MO/TO Operational Metrics Acquirer", 1, "moto-acquirer/overview");

const navGroups = [
    {
        title: "Overview",
        path: "moto-acquirer/operational-metrics-overview",
        visualizationIds: ["aa382U9paRMt", "aao9cnklbDy9", "aat9cJquaSrU", "aaB9eUt2dGU6"]
    },
    {
        title: "Detail",
        path: "moto-acquirer/operational-metrics-detail",
        visualizationIds: ["abi9nsq9g8tn", "aaf9uMtsiqJl", "abe9r270gVgW", "abu9niUhg2NX", "ace9q6Sghof1"]
    },
    {
        title: "Merchant Analysis",
        path: "moto-acquirer/operational-metrics-merchant-analysis",
