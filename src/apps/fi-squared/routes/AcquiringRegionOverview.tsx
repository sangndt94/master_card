...
const AcquiringRegionOverview: React.FC = () => {
    const { filters, visFilters, clearFilters, applyFilters, resetFilters } = useFilters("acquirerRegion");
                ...
                <Container fluid className="s-dashboard-content">
                    ...
                    <Row>
                        <VisualizationBlockBase
                            ...
                            size={12}
                        >
                            <GeoChart projectId={projectId} identifier="aaODgOf7brKh" filters={visFilters} />
                        </VisualizationBlockBase>
                    </Row>
                </Container>
            ) : (
...
export default AcquiringRegionOverview;
