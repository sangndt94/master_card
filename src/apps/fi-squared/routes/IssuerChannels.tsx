    ...
    return (
        ...
        >
            <Container fluid className="s-dashboard-content">
                ...
                <Row>
                    <VisualizationBlock
                        header={`Card Present Gross Fraud BPS Change ${currentVsPreviousQuarter}`}
                        size={6}
                        projectId={projectId}
                        identifier="abKVG65YhiQv"
                        filters={visFilters}
                        enableExports={true}
                    />
