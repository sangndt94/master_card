            ...
            <Container fluid className="s-dashboard-content">
                ...
                <Row>
                    ...
                    <FineCoarseVisualizationBlock
                        ...
                        coarseGranularityVisualization="aa2C0eYmbcNI"
                        fineGranularityVisualization="aaYSlBxuix3B"
                        size={6}
                        projectId={projectId}
                        filters={visFilters}
                        withPeers
                ...
                <Row>
                    <FineCoarseVisualizationBlock
                        ...
                        coarseGranularityVisualization="aaEC1QFCfaaB"
                        fineGranularityVisualization="abUSiH21aNMr"
                        size={6}
                        projectId={projectId}
                        filters={visFilters}
                        withPeers
                    ...
                    <FineCoarseVisualizationBlock
                        ...
                        coarseGranularityVisualization="aalC2hZ2fOrK"
                        fineGranularityVisualization="adzSgaLcfoQn"
                        size={6}
                        projectId={projectId}
                        filters={visFilters}
                        withPeers
