            ...
            <Container fluid className="s-dashboard-content">
                <Grid lg={1}>
                    <VisualizationBlockBase height="auto">
                        ...
                        <VisualizationWrapper
                            header={
                                <BlockHeading>TOP Merchant Category Performance and Penetration</BlockHeading>
                            }
                        ...
                        <VisualizationWrapper
                            header={<BlockHeading>TOP Merchant Category by Gross Fraud BPS</BlockHeading>}
                            height={extraTallHeight}
                            projectId={projectId}
                            filters={visFilters}
                            identifier="ab8YVsYIf8DQ"
                        />
                ...
                <Grid lg={1}>
                    <VisualizationBlockBase height="auto">
                        ...
                        <Hr color={styleGuide.color.textMuted} className={classes.simpleDivider} />
                        <VisualizationWrapper
                            header={<BlockHeading>TOP Merchants Performance and Penetration</BlockHeading>}
                            height={moreTallHeight}
                            projectId={projectId}
                            filters={visFilters}
                        ...
                        <VisualizationWrapper
                            header={<BlockHeading>TOP Merchant by Gross Fraud BPS</BlockHeading>}
                            height={extraTallHeight}
                            projectId={projectId}
                            filters={visFilters}
                            identifier="ae3ZJ4P2bonf"
                        />
                    </VisualizationBlockBase>
                </Grid>
            </Container>
