    ...
    return (
        <div>
            <section id="toc1-" className={classes.section}>
                ...
                <Typography variant="label" className={classes.paragraph}>
                    Benchmarking (Standard) insights is available as part of both standard and premium tiers
            ...
            <section id="toc3-" className={classes.section}>
                <section id="toc3-1" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/overview/1.png")}
                ...
                <section id="toc3-2" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/channel/1.png")}
                        className={classes.image}
                    />
                </section>
                <section id="toc3-3" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/corridor/1.png")}
                        className={classes.image}
                    />
                </section>
                <section id="toc3-4" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/authorization/1.png")}
                        className={classes.image}
                    />
                </section>
                <section id="toc3-5" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/3ds/1.png")}
                        className={classes.image}
                    />
                </section>
                <section id="toc3-6" className={classes.section}>
                    ...
                    <img
                        src={require("./images/benchmarking/standard/emv/1.png")}
                        className={classes.image}
                    />
                </section>
            </section>
...
const GlossaryBenchmarking: React.FC = () => {
    return (
        <GlossaryProductCard
            title="Benchmarking"
...
export default GlossaryBenchmarking;
